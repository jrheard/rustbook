...
fn add_employee(directory: &mut HashMap<String, Vec<String>>, command: &str) {
    ...
    let department_entry = directory.entry(department.to_string())
...
mod chapter_8 {
    ...
    #[test]
    fn test_mode() {
        assert!([2, 3, 4].contains(
                &mode(&vec![1, 2, 3, 4, 5, 10, 200, 3, 2, 4])));
    ...
    #[test]
    fn test_pig_latin() {
        assert_eq!(pig_latin("Hello there how are you I am fine"), "ello-Hay here-tay ow-hay are-hay ou-yay I-hay am-hay ine-fay");
    }
